...
export const workspaceHistory = pgTable(
    "workspace_history",
    {
        id: uuid("id").primaryKey(),
    ...
    (table) => [
        index("idx_workspace_history_workspace_id_created_at").on(table.workspaceId, table.createdAt),
    ],
);
...
export const notes = pgTable(
    ...
    (table) => [
        index("idx_notes_creator_id_upvotes_downvotes_created_at").on(
            table.creatorId,
            table.upvotes,
            table.downvotes,
            table.createdAt,
        ),
        index("idx_notes_creator_id_title_upvotes_downvotes_created_at").on(
            table.creatorId,
            table.title,
            table.upvotes,
            table.downvotes,
        ...
        index("idx_notes_company_id_title_upvotes_downvotes_created_at").on(
            table.companyId,
            table.title,
            table.upvotes,
            table.downvotes,
        ...
        index("idx_notes_company_id_upvotes_downvotes_created_at").on(
            table.companyId,
            table.upvotes,
            table.downvotes,
            table.createdAt,
        ),
        index("idx_notes_status_upvotes_downvotes_created_at").on(
            table.status,
            table.upvotes,
            table.downvotes,
            table.createdAt,
...
export const history = pgTable(
    ...
    (table) => [
        index("idx_history_note_id_created_at").on(table.noteId, table.createdAt),
    ],
);

export const notesVote = pgTable(
    "notes_vote",
    {
        userId: uuid("user_id")
            .notNull()
